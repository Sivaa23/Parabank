package org.parasoft.parabank.reportManager;
...
public class ExtentManager {
    ...
    public static ExtentReports createInstance(String reportFolderPath, String reportName) {
        if (extentReports == null) {
            ...
            htmlReporter.config().setDocumentTitle("Parabank Automation Report");
            htmlReporter.config().setReportName("Parabank TestListnerAutomation Reports ");
